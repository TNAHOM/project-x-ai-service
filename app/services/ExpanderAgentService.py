...
async def run_expander_agent(task: str) -> Tuple[ExpanderResponseSchema, str]:
    ...
    system_prompt = (
        "You are a helpful AI assistant. Review the incoming tasks and determine if each can be handled by the available tools: [create_notion_page, create_google_doc, create_google_sheet, create_google_calendar].\n"
